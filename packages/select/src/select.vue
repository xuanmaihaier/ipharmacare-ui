...
<script type="text/babel">
  ...
  import Focus from 'web-vue2-front-end-lib/src/mixins/focus';
  ...
  import scrollIntoView from 'web-vue2-front-end-lib/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'web-vue2-front-end-lib/src/utils/util';
  import NavigationMixin from './navigation-mixin';
  import { isKorean } from 'web-vue2-front-end-lib/src/utils/shared';
