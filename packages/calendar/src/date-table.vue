<script>
import fecha from 'web-vue2-front-end-lib/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'web-vue2-front-end-lib/src/utils/date-util';
